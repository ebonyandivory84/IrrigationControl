...
const SETTINGS_KEYS = [
    ...
    'automaticMode',
    'autoMorningEnabled',
    'autoMorningTempThresholdC',
    'autoMorningSunThresholdMJm2',
    'autoMorningRainCurrentThresholdMm',
    'autoMorningRainForecastThresholdPct',
    'autoMorningTime',
    'autoEveningEnabled',
    'autoEveningTempThresholdC',
    'autoEveningSunThresholdMJm2',
    'autoEveningRainCurrentThresholdMm',
    'autoEveningRainForecastThresholdPct',
    'autoEveningTime',
    'autoInterimEnabled',
    'autoInterimTempThresholdC',
    'autoInterimSunThresholdWm2',
    'autoInterimRainCurrentThresholdMm',
    'autoInterimRainForecastThresholdPct',
    'maxTotalRuntimeSec',
    'backgroundBlurPx',
    'backgroundDimPct',
    'backgroundImageUrl'
